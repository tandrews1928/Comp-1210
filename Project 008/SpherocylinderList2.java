...
public class SpherocylinderList2 {
   ...
   */
   public Spherocylinder findSpherocylinder(String labelfindIn) {
      for (int i = 0; i < numberof; i++) {
         if (sclist[i].getLabel().equalsIgnoreCase(labelfindIn)) {
            return sclist[i]; 
         }
         else {
            return null; }
   ...
   */
   public boolean editSpherocylinder(String labelIn,
      ...
      return result; }
   /**
   *finds spherocylinder with the shortest radius.
   *@return smallest - the Spherocylinder with the shortest radius.
   */
   ...
   public Spherocylinder findSpherocylinderWithShortestRadius() {
      ...
      if (numberof == 0) {
         ...
         Spherocylinder smallest = sclist[0];  
         for (int i = 0; i < numberof; i++) {
            if (!(smallest.getRadius() < sclist[i].getRadius())) {
               smallest = sclist[i];   
   ...
   /**
   *finds spherocylinder with the longest radius.
   *@return largest - the Spherocylinder with the longest radius.
   */
   public Spherocylinder findSpherocylinderWithLongestRadius() {
      ...
      if (numberof == 0) {
         ...
         for (int i = 0; i < numberof; i++) {
            if (!(largest.getRadius() > sclist[i].getRadius())) {
               largest = sclist[i];   
            }
         }
         return largest;  
   ...
   /**
   *finds spherocylinder with the smallest volume.
   *@return smallest - the Spherocylinder with the shortest volume.
   */
   ...
   public Spherocylinder findSpherocylinderWithSmallestVolume() {
      ...
      if (numberof == 0) {
         ...
         Spherocylinder smallest = sclist[0];  
         for (int i = 0; i < numberof; i++) {
            if (!(smallest.volume() < sclist[i].volume())) {
               smallest = sclist[i];   
            }
         }
         return smallest;  
   ...
   /**
   *finds spherocylinder with the largest volume.
   *@return largest - the Spherocylinder with the largest volume.
   */
   public Spherocylinder findSpherocylinderWithLargestVolume() {
      ...
      if (numberof == 0) {
         ...
         Spherocylinder largest = sclist[0];  
         for (int i = 0; i < numberof; i++) {
            if (!(largest.volume() > sclist[i].volume())) {
               largest = sclist[i];   
            }
         }
         return largest;   
