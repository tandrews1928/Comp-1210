 ...
 */
   public static void main(String[] args) throws FileNotFoundException
   {
      ...
      String label;
      String input;
      SpherocylinderList2 sclist = new SpherocylinderList2(listName, myList, 0);
      ...
      do {
         ...
         switch(codeChar) {
            ...
            case 'R': 
               ...
               sclist = new SpherocylinderList2(listname,
                                           myList, size);
            ...
            case 'D': 
               ...
               if (sclist.deleteSpherocylinder(label) == null) { //need to fix
